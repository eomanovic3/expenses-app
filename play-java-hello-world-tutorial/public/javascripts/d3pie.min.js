...
!function (a, b) {
    ...
    var a = "d3pie", b = "0.2.1", c = 0, e = {
        ...
        size: {canvasHeight: 500, canvasWidth: 500, pieInnerRadius: "0%", pieOuterRadius: null},
        data: {
            sortOrder: "none",
            ignoreSmallSegments: {enabled: !1, valueType: "percentage", value: null},
            smallSegmentGrouping: {enabled: !1, value: 1, valueType: "percentage", label: "Other", color: "#cccccc"},
            content: []
        },
        labels: {
        ...
        callbacks: {onload: null, onMouseoverSegment: null, onMouseoutSegment: null, onClickSegment: null}
    }, f = {
        initialCheck: function (a) {
            var b = a.cssPrefix, c = a.element, d = a.options;
        ...
        addSVGSpace: function (a) {
            var b = a.element, c = a.options.size.canvasWidth, d = a.options.size.canvasHeight,
            ...
            var c = 1, d = 1e3, e = setInterval(function () {
                document.getElementById(a) && (clearInterval(e), b()), c > d && clearInterval(e), c++
            }, 1)
        }, whenElementsExist: function (a, b) {
            var c = 1, d = 1e3, e = setInterval(function () {
                for (var f = !0, g = 0; g < a.length; g++) if (!document.getElementById(a[g])) {
                    f = !1;
                    break
                }
            ...
            var b = document.getElementById(a), c = 0, d = 0;
            if (b) {
                var e = b.getBBox();
            ...
            for (var d = [], e = [], f = 0, g = 0; g < a.length; g++) if ("percentage" === b.valueType) {
            ...
            return e.length && d.push({color: b.color, label: b.label, value: f, isGrouped: !0, groupedData: e}), d
        ...
        var a, b, c, d, e, f, g = arguments[0] || {}, i = 1, j = arguments.length, k = !1,
            l = Object.prototype.toString, m = Object.prototype.hasOwnProperty, n = {
        ...
        for ("boolean" == typeof g && (k = g, g = arguments[1] || {}, i = 2), "object" == typeof g || o.isFunction(g) || (g = {}), j === i && (g = this, --i), i; j > i; i++) if (null !== (a = arguments[i])) for (b in a) c = g[b], d = a[b], g !== d && (k && d && (o.isPlainObject(d) || (e = o.isArray(d))) ? (e ? (e = !1, f = c && o.isArray(c) ? c : []) : f = c && o.isPlainObject(c) ? c : {}, g[b] = h(k, f, d)) : void 0 !== d && (g[b] = d));
        return g
    }, i = {
        toRadians: function (a) {
            ...
            var b = a.options.size, c = a.options.misc.canvasPadding, d = b.canvasWidth - c.left - c.right,
            ...
            var b = a.options.data.content, c = a.options.data.sortOrder;
            switch (c) {
                case"none":
                    break;
                case"random":
            ...
            e = e * Math.PI / 180;
            var f = Math.cos, g = Math.sin, h = (a - c) * f(e) - (b - d) * g(e) + c,
                i = (a - c) * g(e) + (b - d) * f(e) + d;
            return {x: h, y: i}
        ...
        add: function (a, b, c) {
            var d = j.getIncludes(c), e = a.options.labels,
            ...
            var c, d, e, f, g = k.getSegmentAngle(b, a.options.data.content, a.totalSize, {midpoint: !0}),
                h = i.rotate(a.pieCenter.x, a.pieCenter.y - a.outerRadius, a.pieCenter.x, a.pieCenter.y, g),
                j = a.outerLabelGroupData[b].h / 5, l = 6, m = Math.floor(g / 90), n = 4;
            ...
            "straight" === a.options.labels.lines.style ? a.lineCoordGroups[b] = [{x: h.x, y: h.y}, {
                x: e,
                y: f
            }] : a.lineCoordGroups[b] = [{x: h.x, y: h.y}, {x: c, y: d}, {x: e, y: f}]
            ...
            "none" !== a.options.labels[b].format && d3.selectAll("." + a.cssPrefix + "labelGroup-" + b).style("opacity", 0).attr("transform", function (c, d) {
                ...
                if ("outer" === b) e = a.outerLabelGroupData[d].x, f = a.outerLabelGroupData[d].y; else {
                    ...
                    if (a.innerRadius > 0) {
                        var l = k.getSegmentAngle(d, a.options.data.content, a.totalSize, {midpoint: !0}),
                            m = i.translate(a.pieCenter.x, a.pieCenter.y, a.innerRadius, l);
                        j.x = m.x, j.y = m.y
                    }
                    var n = g.getDimensions(a.cssPrefix + "labelGroup" + d + "-inner"), o = n.w / 2, p = n.h / 4;
            ...
            if (!(1 >= d)) {
                ...
                if (!("clockwise" === c && "right" !== h || "anticlockwise" === c && "left" !== h)) {
                    var i = "clockwise" === c ? b + 1 : b - 1, k = a.outerLabelGroupData[b],
                        l = a.outerLabelGroupData[i], m = {
                    ...
                    if ("clockwise" === c) {
                        for (e = 0; b >= e; e++) if (f = a.outerLabelGroupData[e], !j.isLabelHidden(a, e) && g.rectIntersect(f, l)) {
                            j.adjustLabelPos(a, i, k, m);
                            break
                        }
                    } else for (e = d - 1; e >= b; e--) if (f = a.outerLabelGroupData[e], !j.isLabelHidden(a, e) && g.rectIntersect(f, l)) {
                        j.adjustLabelPos(a, i, k, m);
                        break
                    }
            ...
            if (c) {
                var d = c.getBBox(), e = k.getSegmentAngle(b, a.options.data.content, a.totalSize, {midpoint: !0}),
                    f = a.pieCenter.x, g = a.pieCenter.y - (a.outerRadius + a.options.labels.outer.pieDistance),
                    h = i.rotate(f, g, a.pieCenter.x, a.pieCenter.y, e), j = "right";
        ...
        effectMap: {
            ...
            var b = a.pieCenter, c = a.options.colors, d = a.options.effects.load,
            ...
            if (g.isFunction(b)) {
                ...
                b({segment: c.node(), index: e, expanded: d, data: a.options.data.content[e]})
            }
            ...
            a.isOpeningSegment || (a.isOpeningSegment = !0, k.maybeCloseOpenSegment(), d3.select(b).transition().ease(k.effectMap[a.options.effects.pullOutSegmentOnClick.effect]).duration(a.options.effects.pullOutSegmentOnClick.speed).attr("transform", function (b, c) {
                var d = a.arc.centroid(b), e = d[0], f = d[1], g = Math.sqrt(e * e + f * f),
            ...
            var e, f = h({compounded: !0, midpoint: !1}, d), g = b[a].value;
            if (f.compounded) {
                e = 0;
        ...
        offscreenCoord: -1e4, addTitle: function (a) {
            ...
            var b, c = a.textComponents, d = a.options.header.location, e = a.options.misc.canvasPadding,
                f = a.options.size.canvasWidth, g = a.options.header.titleSubtitlePadding;
            ...
            var b, c = a.options.footer.location, d = a.textComponents.footer.w, e = a.options.size.canvasWidth,
                f = a.options.size.canvasHeight, g = a.options.misc.canvasPadding;
        ...
        addTooltips: function (a) {
            ...
            d3.selectAll("#" + a.cssPrefix + "tooltip" + m.currentTooltip).attr("transform", function (b) {
                var c = d3.mouse(this.parentNode), d = c[0] + a.options.tooltips.styles.padding + 2,
            ...
            d3.select("#" + a.cssPrefix + "tooltip" + b).style("opacity", function () {
                ...
                var d = a.options.size.canvasWidth + 1e3, e = a.options.size.canvasHeight + 1e3;
                return "translate(" + d + "," + e + ")"
            })
